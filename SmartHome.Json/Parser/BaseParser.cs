...
namespace SmartHome.Json.Parser
{
    public class BaseParser
    {
        ...
        public BaseParser(CommandJsonEntity commandJson)
        {
        ...
        public BaseParser(CommandJsonEntity commandJson, ICommandPerserService commandPerserService)
        {
        ...
        public void ParseInitiatorAndSetVersionValue()
        {
            GetInitiator();
        ...
        public void ThermalShutDownCommandParse()
        {
