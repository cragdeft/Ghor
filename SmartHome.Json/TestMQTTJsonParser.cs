...
namespace SmartHome.Json
{
  ...
  public class TestMQTTJsonParser : BaseJsonParser
  {
    public TestMQTTJsonParser(string jsonString, MessageReceivedFrom receivedFrom)
    {
      _receivedFrom = receivedFrom;
      _homeJsonMessage = jsonString;
      _homeJsonEntity = JsonDesrialized<HomeJsonEntity>(jsonString);
    }
    public bool SaveMqttTestInfo()
    {
